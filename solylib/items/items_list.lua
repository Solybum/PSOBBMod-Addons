...
local function AddServerItems(server)
    ...
    elseif server == 3 then -- Ephinea
        ...
        t[ 0x00050E ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Green)
        t[ 0x00050F ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Blue)
        t[ 0x000510 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Purple)
        t[ 0x000511 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Red)
        t[ 0x000512 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Yellow)
        t[ 0x000513 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Blue and Green)
        t[ 0x000514 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Rose)
        t[ 0x000515 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Chartreuse)
        t[ 0x000516 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Mauve)
        t[ 0x000517 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Cyan)
        t[ 0x000518 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (Orange)
        t[ 0x000519 ] = { COLOR_RARE, true } -- Diska of Braveman* - Flight Fan (White)
        ...
        t[ 0x006701 ] = { COLOR_RARE, true } -- Baranz Launcher* (Coating: Blue)
        ...
        t[ 0x009C03 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Green)
        t[ 0x009C04 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Blue)
        t[ 0x009C05 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Purple)
        t[ 0x009C06 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Red)
        t[ 0x009C07 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Yellow)
        t[ 0x009C08 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Blue and Green)
        t[ 0x009C09 ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Rose)
        t[ 0x009C0A ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Chartreuse)
        t[ 0x009C0B ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Mauve)
        t[ 0x009C0C ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Cyan)
        t[ 0x009C0D ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (Orange)
        t[ 0x009C0E ] = { COLOR_RARE, true } -- Rainbow Baton* - Flight Fan (White)
        ...
        t[ 0x00AA03 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Green)
        t[ 0x00AA04 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Blue)
        t[ 0x00AA05 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Purple)
        t[ 0x00AA06 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Red)
        t[ 0x00AA07 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Yellow)
        t[ 0x00AA08 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Blue and Green)
        t[ 0x00AA09 ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Rose)
        t[ 0x00AA0A ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Chartreuse)
        t[ 0x00AA0B ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Mauve)
        t[ 0x00AA0C ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Cyan)
        t[ 0x00AA0D ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (Orange)
        t[ 0x00AA0E ] = { COLOR_RARE, true } -- Slicer of Fanatic* - Flight Fan (White)
        ...
        t[ 0x00C001 ] = { COLOR_RARE, true } -- Cannon Rouge* (Coating: Blue)
        ...
        t[ 0x030E66 ] = { COLOR_RARE, true } -- Heart of Flight Fan
        t[ 0x030E67 ] = { COLOR_RARE, true } -- Blue Powder Coating
