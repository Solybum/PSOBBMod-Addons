...
t[ 0x01028E ] = { COLOR_RARE, true } -- GOD'S SHIELD "KOURYU"
...
local function AddServerItems(server)
    ...
    elseif server == 3 then -- Ephinea
        ...
        t[ 0x002401 ] = { COLOR_RARE, true } -- Magical Piece* - The Sigh of a God
        ...
        t[ 0x00BF02 ] = { COLOR_RARE, true } -- Heaven Striker* - Suppressed Gun
